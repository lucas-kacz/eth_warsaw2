 ...
 */
function estimateGasFees({ logger, provider, gasPriceMin, }) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (maxPriorityFeePerGas.eq(0) || maxFeePerGas.eq(0)) {
                logger.warn(`estimateGasFees: maxPriorityFeePerGas or maxFeePerGas too low (maxPriorityFeePerGas: ${maxPriorityFeePerGas.toString()} / maxFeePerGas: ${maxFeePerGas.toString()})`);
                return {};
            }
            return {
