 ...
 */
export type EvmChainName = 'alfajores' | 'arbitrum-one' | 'arbitrum-rinkeby' | 'avalanche' | 'bsc' | 'bsctest' | 'celo' | 'fantom' | 'fuse' | 'goerli' | 'mainnet' | 'mantle' | 'mantle-testnet' | 'matic' | 'moonbeam' | 'mumbai' | 'optimism' | 'private' | 'rinkeby' | 'ronin' | 'sokol' | 'tombchain' | 'xdai';
/**
