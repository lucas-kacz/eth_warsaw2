...
const BATCH_FEE = ethers_1.BigNumber.from(0);
...
const updateRequestSwapFees = (contract, txOverrides) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!currentFees.eq(REQUEST_SWAP_FEES)) {
        const tx = yield contract.updateRequestSwapFees(REQUEST_SWAP_FEES, txOverrides);
        yield tx.wait(1);
        console.log(`currentFees: ${currentFees.toNumber() / 10}%, new fees: ${REQUEST_SWAP_FEES / 10}%`);
    }
});
...
const updateBatchPaymentFees = (contract, txOverrides) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!BATCH_FEE.eq(currentFees)) {
        const tx = yield contract.setBatchFee(BATCH_FEE, txOverrides);
        yield tx.wait(1);
...
const getSignerAndGasFees = (network, hre) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const txOverrides = (yield (0, utils_3.isEip1559Supported)(provider))
        ? yield (0, utils_3.estimateGasFees)({ logger: console, provider })
        : {};
    return {
        signer,
        txOverrides,
