...
import { ClientTypes, CurrencyTypes, ExtensionTypes, RequestLogicTypes } from '@requestnetwork/types';
 ...
 */
export declare const getProxyAddress: (request: ClientTypes.IRequestData, getDeploymentInformation: (network: CurrencyTypes.EvmChainName, version: string) => {
    address: string;
} | null, version?: string) => string;
/**
 ...
 */
export declare function validatePayERC20TransferableReceivable(request: ClientTypes.IRequestData, signerOrProvider: providers.Provider | Signer, amount?: BigNumberish, feeAmountOverride?: BigNumberish): Promise<void>;
/**
 ...
 * @param feeAmountOverride optionally, the custom fee amount
 */
export declare function validateERC20TransferableReceivable(request: ClientTypes.IRequestData, amount?: BigNumberish, feeAmountOverride?: BigNumberish): void;
/**
