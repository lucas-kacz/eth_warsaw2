 ...
 */
export declare function getErc20Allowance(ownerAddress: string, spenderAddress: string, signerOrProvider: providers.Provider | Signer, tokenAddress: string): Promise<BigNumber>;
/**
