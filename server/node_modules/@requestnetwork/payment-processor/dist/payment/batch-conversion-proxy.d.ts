 ...
 * @param overrides Optionally, override default transaction values, like gas.
 */
export declare function approveErc20BatchConversionIfNeeded(request: ClientTypes.IRequestData, account: string, signerOrProvider?: providers.Provider | Signer, amount?: BigNumber, paymentSettings?: IConversionPaymentSettings, version?: string, overrides?: ITransactionOverrides): Promise<ContractTransaction | void>;
/**
 ...
 * @param overrides Optionally, override default transaction values, like gas.
 */
export declare function approveErc20BatchConversion(request: ClientTypes.IRequestData, signerOrProvider?: providers.Provider | Signer, amount?: BigNumber, paymentSettings?: IConversionPaymentSettings, version?: string, overrides?: ITransactionOverrides): Promise<ContractTransaction>;
/**
 ...
 * @param overrides Optionally, override default transaction values, like gas.
 */
export declare function prepareApproveErc20BatchConversion(request: ClientTypes.IRequestData, signerOrProvider?: providers.Provider | Signer, amount?: BigNumber, paymentSettings?: IConversionPaymentSettings, version?: string, overrides?: ITransactionOverrides): IPreparedTransaction;
/**
 ...
 * @param version The version of the batch conversion proxy.
 */
export declare function encodeApproveErc20BatchConversion(request: ClientTypes.IRequestData, signerOrProvider?: providers.Provider | Signer, amount?: BigNumber, paymentSettings?: IConversionPaymentSettings, version?: string): string;
