...
const erc20_transferable_receivable_1 = require("./erc20-transferable-receivable");
...
function getRequestPaymentValues(request) {
    ...
    return Object.assign(Object.assign({}, extension.values), { paymentReference: (0, payment_detection_1.getPaymentReference)(request), network: (_a = extension.values.network) !== null && _a !== void 0 ? _a : request.currencyInfo.network, version: extension.version });
}
...
function validateConversionFeeProxyRequest(request, path, amount, feeAmountOverride) {
    ...
    if (acceptedTokens &&
        !(acceptedTokens === null || acceptedTokens === void 0 ? void 0 : acceptedTokens.map((t) => t.toLowerCase()).includes(tokenAddress.toLowerCase()))) {
