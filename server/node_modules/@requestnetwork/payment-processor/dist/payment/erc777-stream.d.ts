 ...
 */
export declare function encodeCloseStreamRequest(sender: string, request: ClientTypes.IRequestData, sf: Framework): Promise<string>;
/**
 * Prepare the transaction to close a SuperFluid stream.
 * @param request the request to pay
 * @param provider the Web3 provider. Defaults to window.ethereum.
 */
export declare function prepareCloseStreamTransaction(sender: string, request: ClientTypes.IRequestData, provider: providers.Provider): Promise<IPreparedTransaction>;
/**
 ...
 * @param overrides optionally, override default transaction values, like gas.
 */
export declare function closeErc777StreamRequest(request: ClientTypes.IRequestData, signer: Signer, overrides?: Overrides): Promise<ContractTransaction>;
/**
 ...
 */
export declare const makeErc777OneOffPayment: (request: ClientTypes.IRequestData, amount: BigNumber, signer: Signer, overrides?: ITransactionOverrides) => Promise<ContractTransaction>;
