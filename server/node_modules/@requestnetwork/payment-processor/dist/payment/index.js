...
function hasSufficientFunds(request, address, providerOptions) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (paymentNetwork === types_1.ExtensionTypes.PAYMENT_NETWORK_ID.ERC20_FEE_PROXY_CONTRACT ||
            paymentNetwork === types_1.ExtensionTypes.PAYMENT_NETWORK_ID.ETH_FEE_PROXY_CONTRACT) {
...
function isSolvent(fromAddress, currency, amount, providerOptions) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const needsGas = !((_b = (_a = provider === null || provider === void 0 ? void 0 : provider.provider) === null || _a === void 0 ? void 0 : _a.safe) === null || _b === void 0 ? void 0 : _b.safeAddress) &&
            !['Safe Multisig WalletConnect', 'Gnosis Safe Multisig'].includes((_e = (_d = (_c = provider === null || provider === void 0 ? void 0 : provider.provider) === null || _c === void 0 ? void 0 : _c.wc) === null || _d === void 0 ? void 0 : _d._peerMeta) === null || _e === void 0 ? void 0 : _e.name);
