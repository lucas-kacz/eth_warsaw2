...
export interface SuperfluidGovernanceIIInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "authorizeAppFactory" | "batchUpdateSuperTokenLogic" | "batchUpdateSuperTokenMinimumDeposit" | "castrate" | "clearConfig" | "clearPPPConfig" | "clearRewardAddress" | "clearSuperTokenMinimumDeposit" | "clearTrustedForwarder" | "disableTrustedForwarder" | "enableTrustedForwarder" | "getCodeAddress" | "getConfigAsAddress" | "getConfigAsUint256" | "getPPPConfig" | "getRewardAddress" | "getSuperTokenMinimumDeposit" | "isAuthorizedAppFactory" | "isTrustedForwarder" | "owner" | "registerAgreementClass" | "renounceOwnership" | "replaceGovernance" | "setConfig(address,address,bytes32,address)" | "setConfig(address,address,bytes32,uint256)" | "setPPPConfig" | "setRewardAddress" | "setSuperTokenMinimumDeposit" | "transferOwnership" | "unauthorizeAppFactory" | "updateContracts" | "proxiableUUID" | "updateCode"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "clearTrustedForwarder", values: [
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<string>
    ]): string;
...
export interface SuperfluidGovernanceII extends BaseContract {
    ...
    functions: {
        ...
        clearTrustedForwarder(host: PromiseOrValue<string>, superToken: PromiseOrValue<string>, forwarder: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        clearTrustedForwarder(host: PromiseOrValue<string>, superToken: PromiseOrValue<string>, forwarder: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
