...
declare type SupportedProvider = ethers.providers.Provider | HardhatEthersHelpers | Web3;
...
export default class Framework {
     ...
     */
    operation: (txn: Promise<ethers.PopulatedTransaction>, type: OperationType) => Operation;
    /**
